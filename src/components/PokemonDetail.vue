  ...
  <div class="detail">
    <div class="detail-view card">
      <div class="data card-body">
        <img class="imageShiny" :src="pokemonDetails.sprites.front_shiny" />
        <img
          class="image"
          :src="url_image + '/' + pokemonDetails.name + '.png'"
        />
        ...
        <div class="property">
          <div v-bind:key="stat" v-for="stat in pokemonDetails.stats">
            <li class="stats">
              {{ stat.stat.name }}
              :
              <div class="right">
      ...
      <button class="add" v-on:click="add(pokemonDetails)">Ajouter</button>
    </div>
  </div>
</template>
...
export default {
  ...
  props: ["pokemonUrl"],
  methods: {
    ...mapActions(["setBattle"]),
    closeDetail: function () {
      this.$emit("closeDetail", this.PokemonDetail);
    },
    add: function (pokemon) {
      let battle = this.$store.getters.getBattle;
      battle.push(pokemon);
      this.setBattle(battle);
    },
  },
  computed: {
    ...mapGetters(["getBattle"]),
  },
  beforeMount() {
    axios
      .get(this.pokemonUrl)
